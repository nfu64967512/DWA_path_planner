...
class CoverageParameters:
    ...
    # 固定翼參數
    is_fixed_wing: bool = False        # 是否為固定翼
    turn_radius: float = 50.0          # 轉彎半徑（公尺）
    smooth_turns: bool = True          # 是否使用平滑轉彎
...
class CoveragePlanner:
    ...
    def _add_smooth_turns(self,
        ...
        smoothed_path.append(path[-1])  # 保留終點
    ...
    def _generate_arc_turn(self,
        ...
        # 生成圓弧點
        num_arc_points = max(3, int(abs(turn_angle) / math.radians(15)))  # 每15度一個點
